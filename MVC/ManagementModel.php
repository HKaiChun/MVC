...
function sendTransit($username) {
	global $db;
	$sql = "INSERT INTO transit (id, pName, price, num, total, merchant, username, status) SELECT id, pName, price, num, total, merchant, username, 'sent' FROM shop WHERE username = ?;";
